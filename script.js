  ...
  const buildMenu = () => {
    if (winner === human) {
      return /*#__PURE__*/(
        ...
        React.createElement("h1", { className: "title" }, "keren Gess.!!"), /*#__PURE__*/
        React.createElement("hr", null), /*#__PURE__*/
        React.createElement("div", null, /*#__PURE__*/
        React.createElement("p", { className: "menu-text" }, "Mau coba lagi?"), /*#__PURE__*/
      ...
      return /*#__PURE__*/(
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' }, /*#__PURE__*/
        React.createElement("h1", { className: "title" }, "Hampir Gaes\uD83E\uDD23!"), /*#__PURE__*/
        React.createElement("hr", null), /*#__PURE__*/
        React.createElement("div", null, /*#__PURE__*/
        React.createElement("p", { className: "menu-text" }, "Mau lebih syulit?"), /*#__PURE__*/
        React.createElement("button", { onClick: token => startGame('X') }, "X"), /*#__PURE__*/
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
